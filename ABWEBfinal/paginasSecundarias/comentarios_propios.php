...
// Prepara SELECT
$miConsulta = $miPDO->prepare('SELECT * FROM foro WHERE nombre = :nombreUsuario');
$miConsulta-> bindParam(':nombreUsuario', $_SESSION['usuario_nombre']);
// Ejecuta consulta
$miConsulta->execute();
?>
<!DOCTYPE html>
...
<body>
    ...
    <p><a class="button-propios" href="../foro.php">Volver al foro</a></p>
